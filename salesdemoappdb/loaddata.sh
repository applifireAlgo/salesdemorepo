...
echo $PATH
OSNAME=`uname -s`
ART_DATA_PATH=/tmp/applifire/db/SELRWFCB5UHGGEPHHAYZA/18D01ABF-F632-496A-B379-FC50EDEAB8C0/art/data
AST_DATA_PATH=/tmp/applifire/db/SELRWFCB5UHGGEPHHAYZA/18D01ABF-F632-496A-B379-FC50EDEAB8C0/ast/data
MYSQL=/usr/bin
...
$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "load data local infile '$AST_DATA_PATH/ast_Channel_M.csv' into table ast_Channel_M FIELDS TERMINATED BY '#appfire#' LINES TERMINATED BY '\n' ";
...
$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "load data local infile '$AST_DATA_PATH/ast_Material_M.csv' into table ast_Material_M FIELDS TERMINATED BY '#appfire#' LINES TERMINATED BY '\n' ";

$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "load data local infile '$AST_DATA_PATH/ast_SalesRegion_M.csv' into table ast_SalesRegion_M FIELDS TERMINATED BY '#appfire#' LINES TERMINATED BY '\n' ";

$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "load data local infile '$AST_DATA_PATH/ast_Distributor_M.csv' into table ast_Distributor_M FIELDS TERMINATED BY '#appfire#' LINES TERMINATED BY '\n' ";

$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "load data local infile '$AST_DATA_PATH/ast_Retailer_M.csv' into table ast_Retailer_M FIELDS TERMINATED BY '#appfire#' LINES TERMINATED BY '\n' ";
...
$MYSQL/mysql --local-infile=1 -h$HOST -p$PORT -u$USER -p$PASSWORD $DB_NAME -e "load data local infile '$AST_DATA_PATH/ast_CurrentMonth_M.csv' into table ast_CurrentMonth_M FIELDS TERMINATED BY '#appfire#' LINES TERMINATED BY '\n' ";
