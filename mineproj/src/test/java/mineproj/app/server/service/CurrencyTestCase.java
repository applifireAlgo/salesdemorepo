...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("nZ0y1rQpj3W3brylICqBZZaTjc7eGx9X");
            country.setCapitalLatitude(8);
            country.setCapitalLongitude(7);
            country.setCountryCode1("5KD");
            country.setCountryCode2("EUn");
            country.setCountryFlag("wHcCM8A3nGQZ4y45x52CoBDGQHc6TA9yVYH8uJYYPusbnAAj17");
            country.setCountryName("XVR1TU8tW8buBMM9qT93SyquCwVsfqZNnTTW75goUrnoTzr0Fr");
            country.setCurrencyCode("2SE");
            country.setCurrencyName("TocjIemeFkzXi4IZ3kechI6brHk3EjbH6vITmJMtgS059OwJD3");
            country.setCurrencySymbol("aEU2wwSZPCNEGGwczkBafwBCTuUVvsAQ");
            country.setIsoNumeric(10);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("3gv7n2zGws3R9HVeLaxVirlT7a3pRAzFcCM4ABKQbR8bo2MaXn");
            currency.setUnicodeDecimal("eNV3hEpFMd0lWNOahXvcEcFfKFjeSaBojipQFitNNcnUJrR3fM");
            currency.setUnicodeHex("faa9pu8IIrjLfN0aHDItjh0Yl5MPu1xplD6FSPKsuf5OyeOgV3");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("rlYtfRW976zoL0f6UDmoM9rUrF2VFgWFmRS71HnAsxpOvoSoP0");
            currency.setUnicodeDecimal("xlmxeNaH3A5G2ldEXXhUvxuKx7hk24AWqQKWj6KHgppc9U9LGZ");
            currency.setUnicodeHex("I2yj5WpSWVZtaE0RodoULcUtgRvVDf1278T6e26nrS9MzjclAN");
