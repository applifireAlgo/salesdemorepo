...
public class AppCustomerTypeTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomertype.setCustomerType("sc2mrkVIeJAKvpmKZ3ldLqL08zXUZECWRqLeoOXJJtB61DPbag");
    ...
    public void test2Update() {
        try {
            ...
            appcustomertype.setCustomerType("VRSpSOaS6UuSxGNVzCmXG2FCOTKcWN56ERvmtcXFrUwhgOv1Cv");
            appcustomertype.setDefaults(0);
            appcustomertype.setSequenceId(2147483647);
