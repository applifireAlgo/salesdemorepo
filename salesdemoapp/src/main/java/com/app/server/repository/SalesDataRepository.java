...
@SourceCodeAuthorClass(createdBy = "john.doe", updatedBy = "john.doe", versionNumber = "5", comments = "Repository for SalesData Transaction table", complexity = Complexity.MEDIUM)
