...
folder are mapped to the application's root namespace, 'Salesdemoapp'. This is set in
`"app.json"`:

    "sass": {
        "namespace": "Salesdemoapp"
    }
...
included in the application's JavaScript code build. By default, files in this 
folder are mapped to the application's root namespace, 'Salesdemoapp' in the same way
as `"Salesdemoapp/sass/src"`.
