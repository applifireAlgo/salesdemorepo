Ext.define('Salesdemoapp.view.mainleftmenutree.TopPanel.TopPanelController', {
	...
	doVoiceSearch:function(btn){
		...
		if(searchTab.length==0){
			 component = Ext.create(
					"Salesdemoapp.view.searchengine.search.SearchEngineMainPanel", {
						closable : true,
						title : "Search Engine",
						refId : "-1",
						isSearchCmp:true
	...
	onCloudClick : function()
	{
		var component = Ext.create(
				"Salesdemoapp.view.clouddrive.CloudDrive", {
					closable : true,
					title : "Cloud Drive"
					//refId : "-1"
				});
	...
	{
		var component = Ext.create(
				"Salesdemoapp.view.usermanagement.enduser.UserProfile", {
					closable : true,
					title : "My Profile"
				});
