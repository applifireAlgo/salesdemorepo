Ext.define('Salesdemoapp.view.reportbuilder.reportBuilder.ReportConfigurationView', {
	extend : 'Ext.panel.Panel',
	requires: ['Salesdemoapp.view.reportbuilder.querycriteria.QueryCriteriaView',
	           'Salesdemoapp.view.reportbuilder.gridconfig.GridConfigView',
	           'Salesdemoapp.view.reportbuilder.properties.PropertiesPanelView',
	           'Salesdemoapp.view.reportbuilder.sql.SqlListPanelView'],
    xtype:'report-config',
   	layout:'border', 
   	items:[
   	       {
