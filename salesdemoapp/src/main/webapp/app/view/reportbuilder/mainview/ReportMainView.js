Ext.define('Salesdemoapp.view.reportbuilder.mainview.ReportMainView', {
	extend : 'Ext.panel.Panel',
    requires:[
             'Salesdemoapp.view.reportbuilder.reportlist.ReportListPanelView',
             'Salesdemoapp.view.reportbuilder.reportBuilder.ReportBuilderView',
             'Salesdemoapp.view.reportbuilder.mainview.ReportMainController'
             ],
