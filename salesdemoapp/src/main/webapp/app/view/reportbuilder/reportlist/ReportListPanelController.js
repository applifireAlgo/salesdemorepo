Ext.define('Salesdemoapp.view.reportbuilder.reportlist.ReportListPanelController',{
	    	...
	    	Ext.Ajax.request(
	    	{
	    		...
	    		success:function(response, currentObject,options) 
	    		{
	    			...
	    			if (responseJson.response.success == 'true') 
	    			{
			    		...
			    		var tab=Ext.create('Salesdemoapp.view.reportbuilder.reportBuilder.ReportBuilderView', //activeTab
			    		{
			    			closable:true,
			    			iconCls:'editTabIcon',
