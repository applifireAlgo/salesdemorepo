Ext.define('Salesdemoapp.view.reportbuilder.reportlist.ReportListPanelView', {
	extend : 'Ext.panel.Panel',
	requires:['Salesdemoapp.view.reportbuilder.reportlist.ReportListPanelController'],
