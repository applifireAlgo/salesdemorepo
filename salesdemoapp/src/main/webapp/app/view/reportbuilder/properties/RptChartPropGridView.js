Ext.define('Salesdemoapp.view.reportbuilder.properties.RptChartPropGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Salesdemoapp.view.reportbuilder.properties.RptChartPropGridController'],
