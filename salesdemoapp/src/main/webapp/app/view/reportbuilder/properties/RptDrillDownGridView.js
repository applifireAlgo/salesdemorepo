Ext.define('Salesdemoapp.view.reportbuilder.properties.RptDrillDownGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Salesdemoapp.view.reportbuilder.properties.RptDrillDownGridController'],
