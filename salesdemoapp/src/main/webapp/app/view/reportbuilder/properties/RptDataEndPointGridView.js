Ext.define('Salesdemoapp.view.reportbuilder.properties.RptDataEndPointGridView', {
	extend : 'Ext.grid.Panel',
	requires:['Salesdemoapp.view.reportbuilder.properties.RptDataEndPointGridController'],
