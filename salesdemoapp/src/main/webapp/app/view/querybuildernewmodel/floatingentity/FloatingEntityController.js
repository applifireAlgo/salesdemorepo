Ext.define('Salesdemoapp.view.querybuildernewmodel.floatingentity.FloatingEntityController',
{
			extend : 'Ext.app.ViewController',
			alias : 'controller.floating-entity',
			requires:['Salesdemoapp.view.querybuildernewmodel.floatingentity.EntityColumnGrid',
			          'Salesdemoapp.view.querybuildernewmodel.queryentitiesjoins.Query',
			          'Salesdemoapp.view.querybuildernewmodel.floatingentity.EntitySprite',
