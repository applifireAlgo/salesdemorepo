Ext.define('Salesdemoapp.view.querybuildernewmodel.querycondition.QueryWhereCondition', {
	extend : 'Ext.tree.TreePanel',
	requires:['Salesdemoapp.view.querybuildernewmodel.querycondition.QueryWhereConditionController'],
