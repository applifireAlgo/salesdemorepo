 ...
 * 
 */
Ext.define('Salesdemoapp.view.securityconfig.SecurityConfig', {
	extend : 'Ext.form.Panel',
	xtype : 'securityConfig',
	requires : [ 'Salesdemoapp.view.securityconfig.SecurityConfigController',
			'Salesdemoapp.view.securityconfig.SecurityQuestion', 'Ext.form.FieldSet',
