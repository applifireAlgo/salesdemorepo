 ...
 */
Ext.define('Salesdemoapp.view.fw.component.DateTimeField', {
    extend: 'Ext.form.field.Date',
    alias: 'widget.customdatetimefield',
    xtype : 'customdatetimefield',
    requires: ['Salesdemoapp.view.fw.component.DateTimePicker'
               ],
    ...
    createPicker: function() {
        ...
        return new Salesdemoapp.view.fw.component.DateTimePicker(o);
    },
