Ext.define('Salesdemoapp.view.fw.mainViewPanel.MainPanelController', {
	extend : 'Ext.app.ViewController',
	requires : ['Ext.util.Cookies',
	            'Salesdemoapp.view.login.ChangePasswordScreen'],
	...
	afterRender:function()
	{
		...
		if(cookieChangePwd=="true"){
			 var component = Ext.create("Salesdemoapp.view.login.ChangePasswordScreen",
							{
								modal:true,
							});
			 component.show();
