Ext.define('Salesdemoapp.view.fw.frameworkController.RegistrationGridViewController', {
     extend: 'Salesdemoapp.view.fw.frameworkController.FrameworkViewController',
     ...
     onConsoleClick: function() {
          var window = Ext.create('Salesdemoapp.view.console.ConsoleWindow');
