...
Ext
		.define(
				'Salesdemoapp.view.logger.LogConfigurationTabPanel',
				{
					...
					requires : [
							'Salesdemoapp.view.logger.tabs.details.DetailsTab',
							'Salesdemoapp.view.logger.tabs.fileconnector.FileConnectorTab',
							'Salesdemoapp.view.logger.tabs.dbconnector.DBConnectorTab',
							'Salesdemoapp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab',
							'Salesdemoapp.view.logger.tabs.tcpsocketconnector.TCPSocketConnectorTab',
							'Salesdemoapp.view.logger.LogConfigurationTabPanelController',
