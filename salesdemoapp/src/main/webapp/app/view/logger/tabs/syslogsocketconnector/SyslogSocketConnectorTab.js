 ...
 * 
 */
Ext.define('Salesdemoapp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTab', {
	...
	requires : ['Salesdemoapp.view.logger.tabs.syslogsocketconnector.SyslogSocketConnectorTabController'],
