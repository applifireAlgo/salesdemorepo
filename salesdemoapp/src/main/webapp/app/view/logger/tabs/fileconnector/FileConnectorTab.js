 ...
 * 
 */
Ext.define('Salesdemoapp.view.logger.tabs.fileconnector.FileConnectorTab', {
	...
	requires : ['Salesdemoapp.view.logger.tabs.fileconnector.FileConnectorTabController'],
