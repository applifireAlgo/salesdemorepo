 ...
 * 
 */
Ext.define('Salesdemoapp.view.logalarm.mainscreen.AddLogAlarm', {
	extend : 'Ext.form.Panel',
	xtype : 'addLogAlarm',
	requires : [ 'Salesdemoapp.view.logalarm.mainscreen.AddLogAlarmController',
			'Salesdemoapp.view.logalarm.mainscreen.AppAlarmGridPanel',
			'Salesdemoapp.view.logalarm.mainscreen.AppAlarmPanel',
