 ...
 * 
 */
Ext.define('Salesdemoapp.view.logalarm.mainscreen.LogAlarmMainViewTabPanelController', {
	...
	init : function()
	{
		...
		var component = Ext.create("Salesdemoapp.view.logalarm.mainscreen.AddLogAlarm", {
			title : "Log Module",
		});
