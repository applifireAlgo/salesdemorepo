 ...
 * 
 */
Ext.define('Salesdemoapp.view.logalarm.LogAlarmMainView', {
	extend : 'Ext.form.Panel',
	xtype : 'logAlarmMainView',
	requires : [ 'Salesdemoapp.view.logalarm.LogAlarmMainViewController',
			'Salesdemoapp.view.logalarm.tree.LogAlarmTreePanel',
			'Salesdemoapp.view.logalarm.mainscreen.LogAlarmMainViewTabPanel',
