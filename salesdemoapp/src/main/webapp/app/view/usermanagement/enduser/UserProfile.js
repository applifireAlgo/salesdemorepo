Ext.define('Salesdemoapp.view.usermanagement.enduser.UserProfile', {
	extend : 'Ext.form.Panel',
	xtype : 'userProfileView',
	requires : [ 'Salesdemoapp.view.usermanagement.enduser.UserProfileController', 'Salesdemoapp.view.usermanagement.admin.AddUserDetailsViewModel', 'Salesdemoapp.model.AddUserDataModel' ],
