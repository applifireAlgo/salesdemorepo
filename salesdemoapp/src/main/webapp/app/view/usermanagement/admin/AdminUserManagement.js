Ext.define('Salesdemoapp.view.usermanagement.admin.AdminUserManagement', {
	extend : 'Ext.tab.Panel',
	requires : ['Salesdemoapp.view.usermanagement.admin.UserPasswordReset',
	            'Salesdemoapp.view.usermanagement.admin.AddUserDetails',
	            'Salesdemoapp.view.usermanagement.admin.ViewUser'],
