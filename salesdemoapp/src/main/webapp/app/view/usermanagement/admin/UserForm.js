Ext.define('Salesdemoapp.view.usermanagement.admin.UserForm', {
	extend : 'Ext.form.Panel',
	xtype : 'userForm',
	itemId : 'userForm',
	requires : [ 'Salesdemoapp.view.usermanagement.admin.AddUserDetailsViewModel', 'Salesdemoapp.model.AddUserDataModel' ],
