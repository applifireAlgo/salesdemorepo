 ...
 * 
 */
Ext.define("Salesdemoapp.view.scheduleconfiguration.tree.ScheduleConfigTree", {
	extend : 'Ext.panel.Panel',
	requires : [ 'Salesdemoapp.view.scheduleconfiguration.tree.ScheduleConfigTreeController' ],
