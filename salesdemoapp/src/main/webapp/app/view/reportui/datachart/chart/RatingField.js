...
Ext.define('Salesdemoapp.view.reportui.datachart.chart.RatingField', {
	...
	onRender: function(ct, position) {
		Salesdemoapp.view.reportui.datachart.chart.RatingField.superclass.onRender.call(this, ct, position);
	 ...
	 */
	initEvents: function() {
		Salesdemoapp.view.reportui.datachart.chart.RatingField.superclass.initEvents.call(this);
