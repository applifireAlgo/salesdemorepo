Ext.define('Salesdemoapp.view.reportui.datachart.chart.ChartTabView', {
	extend : 'Ext.panel.Panel',
	requires:['Salesdemoapp.view.reportui.datachart.chart.RatingField','Salesdemoapp.view.reportui.datachart.chart.ChartController'],
	xtype : 'chart-tabView',
