Ext
		.define(
				'Salesdemoapp.view.searchengine.search.ResultPanel',
				{
					extend : 'Ext.panel.Panel',
					xtype : 'resultPanel',
					itemId : "resultsTab",
					plugins : 'responsive',
					requires : [ 'Salesdemoapp.view.searchengine.search.SearchEngineMainPanelController','Salesdemoapp.view.searchengine.search.PanelHeaderField' ,'Salesdemoapp.view.searchengine.search.ReportGridView','Salesdemoapp.view.searchengine.search.ReportChartView','Salesdemoapp.view.searchengine.search.documentView','Salesdemoapp.view.searchengine.search.DouMeanView','Salesdemoapp.view.googlemaps.map.MapPanel'],
