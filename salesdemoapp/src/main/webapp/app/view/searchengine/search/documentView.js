Ext
		.define(
				'Salesdemoapp.view.searchengine.search.documentView',
				{
					...
					requires : [
							...
							'Salesdemoapp.view.searchengine.search.documentController',
							'Salesdemoapp.view.searchengine.search.RowExpander' ],
