Ext.define('Salesdemoapp.view.maintopmenu.MainPanel', {
	extend : 'Ext.panel.Panel',
	xtype : 'mainPanelWithTopMenu',

	requires : ['Salesdemoapp.view.maintopmenu.TopPanel',
				'Ext.layout.container.Accordion', 
				'Ext.Img',
				'Ext.button.Split',
				'Salesdemoapp.view.fw.mainViewPanel.MainPanelController' ],
