...
public class UserAccessTestCase {
    ...
    public void test1Save() {
        try {
            ...
            salesregion.setRegionname("hDZsEuK7ytBfq3I9mBFs4HVAu1gvjX7H2WgXQZVzzUxOpbX3Pz");
            ...
            user.setPasswordAlgo("3k4ke7lvHj81ZgQVz8uhRFCO1zb3ernBcPla6zq5IVRjgZREaF");
            user.setPasswordExpiryDate(new java.sql.Timestamp(123456789));
            user.setSessionTimeout(884);
            user.setUserAccessCode(3);
            UserAccessDomain useraccessdomain = new UserAccessDomain();
            useraccessdomain.setDomainDescription("qYcklHRHGV3JaagBo7RM5evNuVZVsd74UBcNlwXDMCKm44yGxa");
            useraccessdomain.setDomainHelp("elEfNUkiYalcZGcQ6E5Uf93I5Cdiz0yEc9Axhg8zdQFi3WtxYP");
            useraccessdomain.setDomainIcon("80EHNjmR2coaeHtOkpDCW3KMVXdQdAQk9bfztgHHEUd4jjVP0J");
            useraccessdomain.setDomainName("2SlhvwlGZfL7gSAYm7rrTL1N6rFSD0A01oRn5WfzwD7XXDzBw9");
            useraccessdomain.setUserAccessDomain(valueGenerator.getRandomInteger(99999, 0));
            UserAccessDomain UserAccessDomainTest = useraccessdomainRepository.save(useraccessdomain);
            map.put("UserAccessDomainPrimaryKey", useraccessdomain._getPrimarykey());
            UserAccessLevel useraccesslevel = new UserAccessLevel();
            useraccesslevel.setLevelDescription("4aoC6I11nZQNYZggozMhftdEE82vM1CfT2OgCb4NiSzMQGiXvo");
            useraccesslevel.setLevelHelp("djGgkQh7vxHvsVRxQHVuvy9DVMSAK2IsMsiVZdxpgdNEZwlXaf");
            useraccesslevel.setLevelIcon("Ph58dWTDW2aS47ZW03gVeumrJzpG80iOOnVXrBFptNCvV3pKcY");
            useraccesslevel.setLevelName("fMNSaWnIMjh6MpQ3fZwwTLWoNg6Y5AfhIUbQOuwaXszTkz7VPy");
            ...
            user.setPasswordAlgo("Aa0Z6QlRaMdohHcEFDRIfqrgv3e0kxD6g8fxPQuHaBo2t9uSf2");
            user.setPasswordExpiryDate(new java.sql.Timestamp(123456789));
            user.setSessionTimeout(1203);
