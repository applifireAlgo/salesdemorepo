...
public class CurrencyTestCase {
    ...
    public void test1Save() {
        try {
            ...
            country.setCapital("0Yqdv1lrCEIWBkUnNDp0hT20jEPP97vP");
            country.setCapitalLatitude(5);
            country.setCapitalLongitude(8);
            country.setCountryCode1("WpR");
            country.setCountryCode2("V25");
            country.setCountryFlag("DGpgA1rvO83SZROXcCX5HqVgaacWx22ClRuWMNARcoaNowFYc9");
            country.setCountryName("NpPTvcjEE3ApDHvEoW4QC2Am18PNs1ppShuoREjQbk7YziElDS");
            country.setCurrencyCode("6OK");
            country.setCurrencyName("NugVTyTxZZLJ89LSzrHhtXkCkuZClMECafElVP2wdsoQQsf0cO");
            country.setCurrencySymbol("WmoCo0e8xO1j4jQQirSHntkzW7MhJzTn");
            country.setIsoNumeric(8);
            Country CountryTest = countryRepository.save(country);
            map.put("CountryPrimaryKey", country._getPrimarykey());
            Currency currency = new Currency();
            currency.setCountryId((java.lang.String) CountryTest._getPrimarykey());
            currency.setCurrencyCode("lPysS8xPM42WrTgQoo5jggQxa3ijJKJOIyBjcper7bcDjvZTsy");
            currency.setUnicodeDecimal("6xBNqK1ZkiTrHxfl9ggD4OOUPwcvOLQsRHxz5DUqtmhLC0Z7mc");
            currency.setUnicodeHex("0xvdH4y2vUfly0OoEGJD12DDd998YXsXBuE51k9ksTB4IDUquz");
    ...
    public void test2Update() {
        try {
            ...
            currency.setCurrencyCode("FkoixhQtVaxku9Cm6qffdULIDOybTaBKbOw1qKBsyJ4Vm5ReSV");
            currency.setUnicodeDecimal("mAfUKDRBARoquY0WyYzWAhHD0oe0qcfjHeO8iGcZuZVqZ1qzX5");
            currency.setUnicodeHex("zGbCte4KMSXQH4m0pRlfKsWUG9uGT0yHadgt4Dyd8noELIijWQ");
