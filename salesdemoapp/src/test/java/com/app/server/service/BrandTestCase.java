...
public class BrandTestCase {
    ...
    public void test1Save() {
        try {
            ...
            category.setCategory("JfAZ0NTMuw3h1ff67BSzZYYsGbZfsebPlBeGBn16EFAGwyIqKo");
            Category CategoryTest = categoryRepository.save(category);
            map.put("CategoryPrimaryKey", category._getPrimarykey());
            Brand brand = new Brand();
            brand.setBranddesc("nXAAZJQTmevuSW6IwPu2X05ZbML6PDFe6GLQBkoEX47VILomnw");
    ...
    public void test2Update() {
        try {
            ...
            brand.setBranddesc("ooubVQSlVwPvjTGeK5grdwFHA3oLoHJsVBl8zldL52zXVIZVFc");
