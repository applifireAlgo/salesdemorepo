...
public class AppCustomerTypeTestCase {
    ...
    public void test1Save() {
        try {
            ...
            appcustomertype.setCustomerType("cObPkuPyUjbtrkmaGD8QRQ5zHVAqSaRuZtTW9bkRwlDjkd1dAK");
    ...
    public void test2Update() {
        try {
            ...
            appcustomertype.setCustomerType("eWUokuamOuQtKx081Xi3GOPHNPn1vQK9IhQ0SplJmqeSLPFJzJ");
            appcustomertype.setDefaults(1);
            appcustomertype.setSequenceId(2147483647);
